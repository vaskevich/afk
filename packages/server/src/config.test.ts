  ...
  it("takes every tunable from its variable", () => {
    const config = loadConfig(
      {
        ...
        AFK_MAX_BYTES_PER_SESSION: "1048576",
        AFK_MAX_SSE_CONNECTIONS_PER_SESSION: "4",
        AFK_MAX_SSE_CONNECTIONS: "8",
    ...
    expect(config).toEqual({
      ...
      limits: {
        ...
        maxFramesPerSession: 15_000,
        maxBytesPerSession: 1_048_576,
        maxSseConnectionsPerSession: 4,
        maxSseConnections: 8,
      },
